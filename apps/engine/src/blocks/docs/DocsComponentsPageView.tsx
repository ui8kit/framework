...
export interface DocsComponentsPageViewProps {
  sidebar: ReactNode;
  title?: string;
  lead?: string;
}
 ...
 * Sidebar is passed from container.
 */
export function DocsComponentsPageView({ sidebar, title = '', lead = '' }: DocsComponentsPageViewProps) {
  return (
