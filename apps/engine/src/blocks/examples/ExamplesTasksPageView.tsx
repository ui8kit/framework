...
/**
 * Examples Tasks page view — task list and checklist patterns.
 */
export function ExamplesTasksPageView() {
  return (
      ...
      <Container max="w-6xl" flex="col" gap="8" data-class="examples-tasks-container">
        ...
        <Card gap="4" data-class="examples-tasks-list">
          <Group justify="between" items="center" p="2" rounded="md" bg="muted" data-class="examples-task-item">
            ...
            <Badge variant="default" data-class="examples-task-badge">Done</Badge>
          </Group>
          <Group justify="between" items="center" p="2" rounded="md" bg="muted" data-class="examples-task-item">
            <Text fontSize="sm" fontWeight="medium" data-class="examples-task-title">
              Task 2
            </Text>
            <Badge variant="secondary" data-class="examples-task-badge">In Progress</Badge>
          </Group>
          <Group justify="between" items="center" p="2" rounded="md" bg="muted" data-class="examples-task-item">
            <Text fontSize="sm" fontWeight="medium" data-class="examples-task-title">
              Task 3
        ...
        <Group gap="2" data-class="examples-tasks-actions">
          ...
          <Button variant="outline" size="sm" data-class="examples-tasks-btn">Clear</Button>
        </Group>
      </Container>
    </Block>
  );
