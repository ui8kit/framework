...
interface DocsComponentsPageViewProps {
  sidebar: ReactNode;
  title?: string;
  lead?: string;
}

export function DocsComponentsPageView(props: DocsComponentsPageViewProps) {
  const { sidebar, title, lead } = props;
    ...
    <DashLayout sidebar={sidebar}>
      <Stack gap="12" data-class="docs-components-content">
          ...
          <Stack gap="4" data-class="component-showcase-variants">
            <Stack gap="2" data-class="variant-group">
              ...
              <Group gap="2" items="center" data-class="variant-row">
                <Button variant="default" data-class="showcase-btn">
                  Default
                </Button>
                <Button variant="primary" data-class="showcase-btn">
                  Primary
                </Button>
                <Button variant="secondary" data-class="showcase-btn">
                  Secondary
                </Button>
                <Button variant="destructive" data-class="showcase-btn">
                  Destructive
                </Button>
                <Button variant="outline" data-class="showcase-btn">
                  Outline
                </Button>
                <Button variant="ghost" data-class="showcase-btn">
                  Ghost
                </Button>
                <Button variant="link" data-class="showcase-btn">
                  Link
                </Button>
              </Group>
            </Stack>
            <Stack gap="2" data-class="variant-group">
              ...
              <Group gap="2" items="center" data-class="variant-row">
                <Button size="xs" data-class="showcase-btn">
                  xs
                </Button>
                <Button size="sm" data-class="showcase-btn">
                  sm
                </Button>
                <Button size="default" data-class="showcase-btn">
                  default
                </Button>
                <Button size="lg" data-class="showcase-btn">
                  lg
                </Button>
                <Button size="xl" data-class="showcase-btn">
                  xl
                </Button>
              </Group>
            </Stack>
        ...
        <Stack gap="4" data-class="component-showcase">
          ...
          <Group gap="2" items="center" data-class="variant-row">
            <Badge variant="default" data-class="showcase-badge">
              Default
            </Badge>
            <Badge variant="secondary" data-class="showcase-badge">
              Secondary
            </Badge>
            <Badge variant="destructive" data-class="showcase-badge">
              Destructive
            </Badge>
            <Badge variant="outline" data-class="showcase-badge">
              Outline
            </Badge>
          </Group>
        </Stack>
        <Stack gap="4" data-class="component-showcase">
          ...
          <Stack gap="4" data-class="layout-demo">
            <Block component="section" p="4" rounded="md" bg="muted" data-class="layout-demo-block">
              <Text fontSize="sm" data-class="layout-demo-label">
                Block (section)
              </Text>
            </Block>
        ...
        <Stack gap="4" data-class="component-showcase">
          ...
          <Stack gap="4" data-class="typography-demo">
            <Stack gap="1" data-class="typography-item">
              <Title order={1} fontSize="4xl" data-class="typography-title">
                Title
              </Title>
              <Text fontSize="xs" textColor="muted-foreground">
                order=1 fontSize="4xl"
              </Text>
            </Stack>
            <Stack gap="1" data-class="typography-item">
              <Title order={2} fontSize="2xl" data-class="typography-title">
                Heading 2
              </Title>
              <Text fontSize="xs" textColor="muted-foreground">
                order=2 fontSize="2xl"
              </Text>
            </Stack>
            <Stack gap="1" data-class="typography-item">
              <Text fontSize="lg" data-class="typography-text">
                Body large
              </Text>
              <Text fontSize="xs" textColor="muted-foreground">
                fontSize="lg"
          ...
          <Stack gap="4" data-class="field-demo">
            <Stack gap="2" data-class="field-demo-group">
              ...
              <Group gap="4" items="center" flex="wrap" data-class="field-demo-row">
                ...
                <Field component={"button"} type={"submit"} data-class={"field-demo-submit"}>
                  Submit
                </Field>
              </Group>
            </Stack>
