...
export function ExamplesPlaygroundPageView() {
  return (
        ...
        <Card gap="6" data-class="examples-playground-content">
          <Stack gap="2" data-class="examples-playground-group">
            ...
            <Group gap="2" items="center" data-class="examples-playground-buttons">
              <Button size="sm" data-class="examples-playground-btn">
                Small
              </Button>
              <Button size="default" data-class="examples-playground-btn">
                Default
              </Button>
              <Button size="lg" data-class="examples-playground-btn">
                Large
              </Button>
            </Group>
          </Stack>
          <Stack gap="2" data-class="examples-playground-group">
            ...
            <Group gap="2" items="center" data-class="examples-playground-badges">
              <Badge variant="default" data-class="examples-playground-badge">
                Default
              </Badge>
              <Badge variant="secondary" data-class="examples-playground-badge">
                Secondary
              </Badge>
              <Badge variant="outline" data-class="examples-playground-badge">
                Outline
              </Badge>
            </Group>
          </Stack>
