      ...
      <Stack gap="8" data-class="docs-content">
        <Stack gap="4" data-class="docs-header">
          ...
          <Text fontSize="lg" textColor="muted-foreground" data-class="docs-lead">
            UI8Kit is a design system that combines React development with semantic HTML5/CSS3 output. Build interactive apps during development, generate production-ready templates for multiple engines.
          </Text>
        </Stack>
        <Stack gap="6" data-class="docs-sections">
          <Stack gap="2" data-class="docs-section">
            ...
            <Text fontSize="base" textColor="muted-foreground" data-class="docs-section-text">
              Components, variants, and tokens. All styled via semantic props — no raw Tailwind. Shadcn-style theming with CSS variables.
            </Text>
          </Stack>
          <Stack gap="2" data-class="docs-section">
            <Title fontSize="xl" fontWeight="semibold" data-class="docs-section-title">
            ...
            <Text fontSize="base" textColor="muted-foreground" data-class="docs-section-text">
              Valid W3C output. Proper landmarks (header, main, nav, section, article). Accessible and SEO-friendly.
            </Text>
          </Stack>
          <Stack gap="2" data-class="docs-section">
            <Title fontSize="xl" fontWeight="semibold" data-class="docs-section-title">
            ...
            <Text fontSize="base" textColor="muted-foreground" data-class="docs-section-text">
              One source — React DSL. Generate to React, Liquid, Handlebars, Twig, Latte. Ready for CDN and MCP registry.
            </Text>
          </Stack>
        </Stack>
      </Stack>
