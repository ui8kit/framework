        ...
        <Stack gap="6" data-class="docs-install-sections">
          ...
          <Stack gap="2" data-class="docs-install-section">
            ...
            <Text fontSize="base" textColor="muted-foreground" data-class="docs-install-text">
              Copy shadcn.css or your theme variables. CSS variables power the semantic tokens (primary, secondary, muted, destructive, etc.).
            </Text>
          </Stack>
          <Stack gap="2" data-class="docs-install-section">
            <Title fontSize="xl" fontWeight="semibold" data-class="docs-install-section-title">
            ...
            <Text fontSize="base" textColor="muted-foreground" data-class="docs-install-text">
              ...
              in apps/engine to build React templates. Output goes to dist/react/. Copy to your app or use via CDN registry.
            </Text>
          </Stack>
        </Stack>
      </Stack>
